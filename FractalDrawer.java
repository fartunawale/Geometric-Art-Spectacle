...
public class FractalDrawer {
    ...
    double y, Color c, Canvas can, int level){
        ...
        // each fractal level will have the same color from the color array
    ...
    public static void main(String[] args){
      ...
      // instead of writing the shape, entering a,b, or c is faster, easier and more efficient.
      System.out.println("\nChoose a shape to draw: a, b, or c \n a. circle\n b. rectangle\n c. triangle\n");
      String output = input.nextLine();
      // scanner will read the user input and check against the if statements below
      ...
      else{ // if output isn't a,b, or c, then no shape will be printed.
